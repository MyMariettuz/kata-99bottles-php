...
class Song99BottlesTest extends TestCase
{
    ...
    {
        $this->assertEquals("99 bottles of beer on the wall, 99 bottles of beer.
    ...
    public function testGetFirstLine(): void
    {
        $this->assertEquals(
            ...
            $this->song99Bottles->getFirstLineUntilOneBottle(99)
        );
    }
    ...
    public function testGetSecondLine(): void
    {
        $this->assertEquals(
            "Take one down and pass it around, 98 bottles of beer on the wall.",
            $this->song99Bottles->getSecondLineUntilOneBottle(98)
        );
    }

    public function testGetFirstVerse(): void
    {
        $this->assertEquals(
            "99 bottles of beer on the wall, 99 bottles of beer. Take one down and pass it around, 98 bottles of beer on the wall.",
            $this->song99Bottles->getVerseUntil3Bottles(99)
        );
    }
    ...
    public function testGetFirstLineSecondVerse(): void
    {
        $this->assertEquals(
            "98 bottles of beer on the wall, 98 bottles of beer.",
            $this->song99Bottles->getFirstLineUntilOneBottle(98)
        );
    }

    public function testGetSecondLineSecondVerse(): void
    {
        $this->assertEquals(
            "Take one down and pass it around, 97 bottles of beer on the wall.",
            $this->song99Bottles->getSecondLineUntilOneBottle(97)
        );
    }

    public function testGetSecondVerse(): void
    {
        $this->assertEquals(
            "98 bottles of beer on the wall, 98 bottles of beer. Take one down and pass it around, 97 bottles of beer on the wall.",
            $this->song99Bottles->getVerseUntil3Bottles(98)
        );
    }
    ...
    public function testGetFirstLineLastVerse(): void
    {
        $this->assertEquals(
            "No more bottles of beer on the wall, no more bottles of beer.",
            $this->song99Bottles->getFirstLineLastVerse("no more")
        );
    }
    ...
    public function testGetSecondLineLastVerse(): void
    {
        $this->assertEquals(
            "Go to the store and buy some more, 99 bottles of beer on the wall.",
            $this->song99Bottles->getSecondLineLastVerse(99)
        );
    }
    ...
    public function testGetAllVerseNoLast(): void
    {
        $this->assertEquals(
            "99 bottles of beer on the wall, 99 bottles of beer. Take one down and pass it around, 98 bottles of beer on the wall.
98 bottles of beer on the wall, 98 bottles of beer. Take one down and pass it around, 97 bottles of beer on the wall.
...
3 bottles of beer on the wall, 3 bottles of beer. Take one down and pass it around, 2 bottles of beer on the wall.",
            $this->song99Bottles->getAllVerseUntil3Bottles()
        );
    }
}
